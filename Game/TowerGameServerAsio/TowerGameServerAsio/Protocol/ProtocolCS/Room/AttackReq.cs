...
public struct AttackReq : IFlatbufferObject
{
  ...
  public static Offset<AttackReq> CreateAttackReq(FlatBufferBuilder builder,
    ...
    AttackReq.AddAccountUID(builder, accountUID);
    AttackReq.AddObjectID(builder, objectID);
    return AttackReq.EndAttackReq(builder);
  }

  public static void StartAttackReq(FlatBufferBuilder builder) { builder.StartObject(2); }
